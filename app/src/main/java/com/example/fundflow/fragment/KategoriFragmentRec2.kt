...
class KategoriFragmentRec2 : Fragment() {
    ...
    override fun onCreateView(
        ...
        categoryAdapter = CategoryAdapter(requireContext(), categoryList, "Pengeluaran") // atau "Pengeluaran"
        recyclerViewCategory.adapter = categoryAdapter

        // Load categories from Firestore
        loadCategoriesFromFirestore("Pengeluaran")
    ...
    private fun showEmptyState() {
        // Display an empty state message or image
        println("No categories available.")
    }

    private fun showErrorState() {
        // Display an error state message to the user
